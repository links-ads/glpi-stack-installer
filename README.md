...
```bash
curl -fsSL https://links-ads.github.io/glpi-stack-installer/glpi-installer.sh | bash -s -- [OPTIONS]
e.g.
curl -fsSL https://links-ads.github.io/glpi-stack-installer/glpi-installer.sh | bash -s -- -d . -k ~/.ssh/glpi_ed25519
```
